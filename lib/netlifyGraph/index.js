...
const subscribeToIssuesSubscription = (
    variables,
    rawOptions
    ) => {
      const options = rawOptions || {};
      const netlifyGraphWebhookId = options.netlifyGraphWebhookId;
      const netlifyGraphWebhookUrl = options.webhookUrl || `${process.env.DEPLOY_URL}/api/IssuesSubscription?netlifyGraphWebhookId=${netlifyGraphWebhookId}`;
...
export const fetchRepoIssuesQuery = (
      variables,
      options
    ) => {
      return fetchNetlifyGraph({
